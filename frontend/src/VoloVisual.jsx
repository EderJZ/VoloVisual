...
const GlobeIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
    ...
    <path
      d="M24 8 Q32 16 32 24 Q32 32 24 40 Q16 32 16 24 Q16 16 24 8Z"
      stroke={gold}
      strokeWidth="1"
    />
...
function CustomCursor() {
  ...
  useEffect(() => {
    ...
    document
      .querySelectorAll(
        "a, button, .servico-card, .portfolio-item, .depoimento-card",
      )
      .forEach(grow);
...
function Navbar() {
  ...
  const getHref = (l) =>
    `#${l.toLowerCase().replace("ó", "o").replace("ç", "c").replace("í", "i")}`;
      ...
      {menuOpen && (
        ...
        >
          ...
          <div style={{ marginTop: 40, textAlign: "center" }}>
            ...
            <a
              href="mailto:contato@volovisual.com"
              style={{
                fontSize: "0.95rem",
                color: gray,
                textDecoration: "none",
            ...
            >
              contato@volovisual.com
            </a>
            <a
              href="tel:+5541999990000"
              style={{
                fontSize: "0.95rem",
                color: gray,
                textDecoration: "none",
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 60% 50% at 50% 60%, rgba(201,168,76,0.06) 0%, transparent 70%), linear-gradient(160deg, #0A0A0A 30%, #111108 70%, #0A0A0A 100%)",
        }}
      />
      {/* Grid */}
      <div
      ...
      >
        ...
        >
          Capturamos o mundo de perspectivas que nenhum outro equipamento
          alcança. Filmagem em 4K e 8K com drones de alta performance.
        </p>

        <div
          className="anim-fade-up-4 hero-btns"
          style={{
            display: "flex",
            gap: 20,
            justifyContent: "center",
...
function SectionLabel({ children, centered }) {
  return (
    <p
      className={`reveal section-label-line`}
      style={{
        fontFamily: "'Cinzel', serif",
        fontSize: "0.6rem",
        letterSpacing: "0.5em",
  ...
  const valores = [
    {
      n: "01",
      t: "Precisão",
      d: "Cada frame é planejado e executado com excelência.",
    },
    {
      n: "02",
      t: "Criatividade",
      d: "Perspectivas únicas que contam histórias visuais inesquecíveis.",
    },
    {
      n: "03",
      t: "Qualidade",
      d: "Equipamentos profissionais e entrega em ultra-alta definição.",
    },
    {
      n: "04",
      t: "Confiança",
      d: "Pilotos certificados pela ANAC e seguros em todas as operações.",
    },
  ];
    ...
    <section id="sobre" style={{ padding: "140px 60px", background: dark2 }}>
      ...
      >
        ...
        <div>
          ...
          <SectionTitle delay={1}>
            Onde Arte e<br />
            Tecnologia <span style={{ color: gold }}>Voam</span>
          </SectionTitle>
          <p
          ...
          >
            A Volo Visual nasceu da paixão por capturar o mundo de perspectivas
            impossíveis. Unimos tecnologia de ponta com sensibilidade
            cinematográfica para criar imagens que transcendem o ordinário.
          </p>
          <p
          ...
          >
            Nossa equipe de pilotos certificados e cinegrafistas profissionais
            domina cada detalhe da captação aérea — do planejamento de voo à
            entrega final em 4K ou 8K.
          </p>
          ...
          >
            {valores.map((v, i) => (
              ...
              >
                ...
                <div
                  style={{ fontSize: "0.95rem", color: gray, lineHeight: 1.7 }}
                >
                  {v.d}
                </div>
              </div>
...
const servicos = [
  {
    n: "01",
    title: "Filmagem Aérea com Drone",
    desc: "Captação aérea profissional em 4K e 8K, com estabilização avançada e planejamento de voo personalizado para cada projeto.",
    Icon: DroneIcon,
  },
  {
    n: "02",
    title: "Produção Cinematográfica",
    desc: "Produções completas com direção de fotografia, iluminação e edição. Spots publicitários, clipes musicais e documentários.",
    Icon: CameraIcon,
  },
  {
    n: "03",
    title: "Fotografia Aérea",
    desc: "Imagens estáticas de alta resolução para arquitetura, imóveis, eventos e registros geográficos com tratamento profissional.",
    Icon: PhotoIcon,
  },
  {
    n: "04",
    title: "Mapeamento e Inspeção",
    desc: "Levantamentos topográficos, ortomosaicos e inspeções técnicas em estruturas e áreas de difícil acesso.",
    Icon: GlobeIcon,
  },
  {
    n: "05",
    title: "Cobertura de Eventos",
    desc: "Casamentos, shows, festivais e eventos corporativos com cobertura aérea em tempo real, transmissão ao vivo disponível.",
    Icon: PhoneIcon,
  },
  {
    n: "06",
    title: "Pós-Produção e Color",
    desc: "Edição avançada, correção de cor cinematográfica, efeitos visuais e masterização para broadcast, streaming e cinema.",
    Icon: TriangleIcon,
  },
];
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <SectionTitle delay={1}>
              Nossos <span style={{ color: gold }}>Serviços</span>
            </SectionTitle>
          </div>
          <a
            href="#contato"
        ...
        <div
          ...
          className="servicos-grid-resp"
        >
          {servicos.map((s, i) => (
            <div
              key={s.n}
              className={`servico-card reveal${i % 3 > 0 ? ` reveal-delay-${i % 3}` : ""}`}
              style={{
                background: dark3,
                padding: "48px 40px",
                position: "relative",
...
function Portfolio() {
  return (
    <section
      id="portfolio"
      style={{ padding: "140px 60px", background: dark2 }}
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div
          style={{
        ...
        >
          <div>
            ...
            <SectionTitle delay={1}>
              Nosso <span style={{ color: gold }}>Portfólio</span>
            </SectionTitle>
          </div>
          <a
            href="#contato"
          ...
          {portfolioItems.map((item, i) => (
            ...
            >
              ...
              >
                <div
                  className="port-icon"
                  style={{ opacity: 0.06, transition: "opacity 0.4s" }}
                >
...
const steps = [
  {
    n: "01",
    t: "Briefing e Planejamento",
    d: "Entendemos sua visão, definimos objetivos, analisamos locações e elaboramos o plano de voo e produção completo.",
  },
  {
    n: "02",
    t: "Pré-Produção",
    d: "Licenças, autorizações ANAC, reconhecimento do terreno, preparação de equipamentos e equipe técnica.",
  },
  {
    n: "03",
    t: "Captação",
    d: "Operação de voo com drones de alto desempenho, câmeras profissionais e monitoramento em tempo real.",
  },
  {
    n: "04",
    t: "Entrega Final",
    d: "Edição, correção de cor, masterização e entrega nos formatos solicitados dentro do prazo acordado.",
  },
];
    ...
    <section id="processo" style={{ padding: "140px 60px", background: dark }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 10 }}>
          ...
          <SectionTitle centered delay={1}>
            Nosso <span style={{ color: gold }}>Processo</span>
          </SectionTitle>
        </div>
        <div
          className="processo-steps"
          style={{
            display: "grid",
        ...
        >
          {steps.map((s, i) => (
            ...
            >
              ...
              <p style={{ fontSize: "0.95rem", color: gray, lineHeight: 1.9 }}>
                {s.d}
              </p>
            </div>
          ))}
...
function Videos() {
  return (
    <section
      id="depoimentos"
      style={{ padding: "140px 60px", background: dark2, overflow: "hidden" }}
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 80 }}>
          <SectionLabel centered>Nosso Trabalho</SectionLabel>
          <SectionTitle centered delay={1}>
            Produções em <span style={{ color: gold }}>Destaque</span>
          </SectionTitle>
          <p
            className="reveal reveal-delay-2"
            style={{
          ...
          >
            Veja como transformamos visões em produções cinematográficas aéreas
            únicas.
          </p>
        </div>
          ...
          {videos.map((v, i) => (
            <div key={i} className={`reveal${i > 0 ? " reveal-delay-1" : ""}`}>
              ...
              <div style={{ padding: "24px 4px 0" }}>
                ...
                <p
                  style={{ fontSize: "0.95rem", color: gray, lineHeight: 1.8 }}
                >
                  {v.desc}
                </p>
              </div>
...
${form.mensagem}
  ...
  const contactInfos = [
    {
      label: "E-mail",
      value: "carlosvzm@gmail.com",
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path d="M3 3h12v10H3z" stroke={gold} strokeWidth="1" />
          <path d="M3 3l6 5 6-5" stroke={gold} strokeWidth="1" />
        </svg>
      ),
    },
    {
      label: "Telefone / WhatsApp",
      value: "+55 41 99827-6136",
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path
            d="M3 3c0 8 4 12 12 12l1-3-3-1-1 1c-2-1-4-3-5-5l1-1-1-3z"
            stroke={gold}
            strokeWidth="1"
          />
        </svg>
    ...
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
          <circle cx="9" cy="8" r="3" stroke={gold} strokeWidth="1" />
          <path
            d="M9 1C6 1 3 3.7 3 7c0 4 6 10 6 10s6-6 6-10c0-3.3-3-6-6-6z"
            stroke={gold}
            strokeWidth="1"
          />
        </svg>
  ...
  return (
    <section id="contato" style={{ padding: "140px 60px", background: dark }}>
      <div
        ...
        className="contato-grid-resp"
      >
        {/* Info */}
        <div>
          <SectionLabel>Fale Conosco</SectionLabel>
          <SectionTitle delay={1}>
            Vamos Criar <span style={{ color: gold }}>Juntos</span>
          </SectionTitle>
          <p
            className="reveal reveal-delay-2"
            style={{
          ...
          >
            ...
            úteis com uma proposta personalizada.
          </p>
          <div
            className="reveal reveal-delay-3"
        ...
        >
          ...
          >
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
              <path
                d="M11 2C6.03 2 2 6.03 2 11c0 1.6.42 3.1 1.15 4.4L2 20l4.72-1.13A9 9 0 1 0 11 2z"
                stroke={gold}
                strokeWidth="1.2"
                fill="none"
              />
              <path
                d="M8 8.5c.2-.5.8-1.5 2-1.5s1.8.8 1.8 1.5c0 1.2-1.3 1.8-1.8 2.5-.3.5-.2 1-.2 1M11 15h.01"
                stroke={gold}
                strokeWidth="1.2"
                strokeLinecap="round"
              />
          ...
          <button
            ...
            style={{
              ...
              letterSpacing: "0.25em",
              textTransform: "uppercase",
              color: submitted ? white : dark,
              background: submitted ? "#5a8a5a" : gold,
              border: "none",
              padding: "18px 40px",
              transition: "all 0.3s",
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: "0.95rem", color: gray, lineHeight: 1.9 }}>
              Produções audiovisuais aéreas com excelência técnica e visão
              artística. Capturamos o mundo de perspectivas que nenhum outro
              equipamento alcança.
            </p>
          </div>
          <div>
        ...
        >
          ...
          >
            © 2025 Volo Visual. Todos os direitos reservados.
          </p>
...
export default function VoloVisual() {
  ...
  useEffect(() => {
    ...
    if (!document.querySelector('link[href*="Cinzel"]')) {
      ...
      link.rel = "stylesheet";
      link.href =
        "https://fonts.googleapis.com/css2?family=Cinzel+Decorative:wght@400;700&family=Cinzel:wght@400;600&family=Montserrat:wght@300;400;500;600&display=swap";
